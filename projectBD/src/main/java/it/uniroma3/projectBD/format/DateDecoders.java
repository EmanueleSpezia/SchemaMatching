...
import static it.uniroma3.projectBD.format.DateFormatFinder.*;
import static it.uniroma3.projectBD.format.FormatRule.tokenRule;
...
public enum DateDecoders implements TypeDecoder {
	...
	private Date parseDateComponents(List<String> tokens) {
		...
		return (day>-1 || month>-1 || year>-1 )? new Date(day,month,year):null;
	}
