...
import static it.uniroma3.projectBD.format.FormatRule.numberRule;
import static it.uniroma3.projectBD.format.Regexps.*;
import static it.uniroma3.projectBD.format.UnitMeasure.FOOT;
import static it.uniroma3.projectBD.format.UnitMeasure.INCHES;

/**
 * A {@link FormatRule} with the semantics to interpret the
 * extracted string occurrence as a {@link Number}.
 * See  method {@link #decodeNumber(String)}.
 *
 */
