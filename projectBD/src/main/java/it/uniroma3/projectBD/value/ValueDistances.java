...
//	}
	...
	static final public double dateDistance(Object value1, Object value2) {
		try {
			...
			double result  = 1 - DateDistance.normalizedDistance(date1,date2);
		    return result;
	...
	static final public double numberDistance(Object value1, Object value2) {
		try {
		/*final double d1 = Double.valueOf(((Value)value1).getValue().toString());
		final double d2 = Double.valueOf(((Value)value2).getValue().toString());*/
	...
	static final public double dimensionalDistance(Object value1, Object value2) {
		...
		if (dn1==null || dn2== null ) return 1d;
		if (dn1.getMarker()!=null && dn2.getMarker()!= null &&!dn1.getMarker().equals(dn2.getMarker())) return 1d;
